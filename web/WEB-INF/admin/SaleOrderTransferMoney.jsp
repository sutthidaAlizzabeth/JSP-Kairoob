<%-- 
    Document   : SaleOrderTransferMoney
    Created on : Apr 20, 2015, 11:38:14 PM
    Author     : nattha
--%>
...
<html>
    <head>
        ...
        <title>SaleOrderTransferMoney</title>
    </head>
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a  href="MemberDetailAdmin.jsp"><i class="fa fa-user fa-3x"></i>Member Details</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        ...
                                        <li>
                                            <a class="active-menu" href="SaleOrderTransferMoney.jsp">สรุปยอดการสั่งซื้อที่ชำระเงินด้วยการโอนเงิน</a>
                                        </li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row"> 
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                สรุปยอดการสั่งซื้อที่ชำระเงินด้วยการโอนเงิน     
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row"> 
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                ตารางสรุปยอดการสั่งซื้อที่ชำระเงินด้วยการโอนเงิน     
                            </h1>
