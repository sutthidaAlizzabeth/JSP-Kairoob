<%-- 
    Document   : header
    Created on : Jun 3, 2015, 9:44:28 PM
    Author     : Alizzabeth
--%>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <%
                    if ((Member) request.getSession().getAttribute("user") == null) {
                %>
                <li>
                ...
                <li>
                    <a href="<%=response.encodeURL("Login")%>">
                ...
                %>
                <li>
                    <a href="<%=response.encodeURL("AccountShow")%>">
                        <span class="glyphicon glyphicon-user"></span>
                        <span> User</span>
                    </a>
                </li>
