<%-- 
    Document   : SaleOrderPaymentVisa
    Created on : Apr 20, 2015, 11:32:32 PM
    Author     : nattha
--%>
...
<html>
    <head>
        ...
        <title>SaleOrderPaymentVisa</title>
    </head>
    <body>
        <div id="wrapper">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a class="active-menu" href="SaleOrderPaymentVisa.jsp">สรุปยอดการสั่งซื้อที่ชำระเงินผ่าน visa</a>
                                        </li>
                                        <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row"> 
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                สรุปยอดการสั่งซื้อที่ชำระเงิน ผ่าน visa  
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row"> 
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                ตารางสรุปยอดการสั่งซื้อที่ชำระเงินผ่าน visa
                            </h1>
